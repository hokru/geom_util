...
if(nat1>1.and.nat2>2) then 
 ...
 write(6,'(''**********************************************'')')
 write(6,'('' angle between planes'',f10.4,5x,a)') acos(cosph)*180.0d0/3.1415927
else
...
rsum=0.0d0
if(nat2>1) then
 write(6,'('' distance set 1 atoms to plane 2'')')
 do i=1,nat1
...
if(nat1>1) then
 write(6,'('' distance set 2 atoms to plane 1'')')
 do i=1,nat2
...
if(nat1>1.and.nat2>1) write(6,'('' average distance between planes (Ang.)'',F12.4)') rsum/(nat1+nat2)
write(6,'(''**********************************************'')')
